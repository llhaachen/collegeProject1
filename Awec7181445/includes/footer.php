...
<link rel="stylesheet" type="text/css" href="footerstyle.php">
<footer>
     <div class="container-fluid bg-primary py-3" style="background-color: #424344 !important">
    <div class="container">
      <div class="row">
        <div class="col-md-7">
            <div class="row py-0">
    ...
    <!--/.footer-->
<p class="text-center"> Copyright © NEP EVENTS. </p>
    <!--/.footer-bottom--> 